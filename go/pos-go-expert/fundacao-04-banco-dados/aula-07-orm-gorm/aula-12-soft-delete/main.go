...
func main() {
	...
	fmt.Println("=== update =======================")
	// update all
	var productUpdate ProductsGorm
	db.Find(&productUpdate, "name=?", "linuxbook")
	productUpdate.Name = "linux pc"
	db.Save(&productUpdate)

	fmt.Println("=== delete =======================")
	// delete all
	var productDelete ProductsGorm
	db.Find(&productDelete, "name=?", "linux pc")
